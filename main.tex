...
\include{Chapters/DSMC-01} % INHOMOGENEOUS GAS
\include{Chapters/MAJ-01}  % Majorana Interlude
\include{Chapters/DSMC-02} % DSMC WITH SPIN - EHRENFEST
\include{Chapters/DSMC-03} % DSMC WITH SPIN - MCWF
...
\include{Chapters/Chapter04} % Chapter 4 - blank template
...
\include{Chapters/CUDADSMC} % Chapter 4 - blank template
...
\include{Chapters/0-ThermalPhysics} %Appendix ? - Thermal Physics stuff -- collision rates etc.
\include{Chapters/B-MagneticTrapping} % Appendix ? - magnetic trapping
\include{Chapters/A-RandomNumbers} % Appendix ? - random number generation and testing
\include{Chapters/A-MotionIntegration} % Appendix ? - Motion Integration
\include{Chapters/Chapter0A} % Appendix A - Direct Simulation Monte Carlo
\include{Chapters/Chapter0B} % Appendix B - Non-Dimensionalisation
\include{Chapters/Chapter0C} % Appendix B - Finite Element Method
