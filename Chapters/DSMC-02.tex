...
\makebox[1.8\linewidth][l]{%
\centering
\subfloat{\label{fig:lab_frame_legend}\includegraphics{gfx/Chapter-4/labframe_legend}}\quad
\subfloat{\label{fig:rot_frame_legend}\includegraphics{gfx/Chapter-4/rotframe_legend}}
}
