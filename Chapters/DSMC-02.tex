...
The laboratory frame is the frame in which the spin up direction is aligned with the stationary $z$-axis, the co-rotating frame is the frame in which the spin up direction is aligned with the local, dynamic magnetic field.
The differential equation has been set in the laboratory frame, however in this frame it can become a little confusing about whether a particular spin state is flipped our not.
...
That is to say for $t<0$ a dominance of $\ket{\uparrow_z}$ represents a partially aligned state, while for $t>0$ a dominance of $\ket{\downarrow_z}$ represents a partially aligned state.
...
%\makebox[1.8\linewidth][l]{%
%\centering
%\subfloat[Co-rotating frame spins]{\label{fig:ehrenfestSpin}\includegraphics[width=0.525\textwidth]{gfx/Chapter-4/ehrenfestSpin}}\quad
%\subfloat[Position and velocity]{\label{fig:ehrenfestPos}\includegraphics[width=0.525\textwidth]{gfx/Chapter-4/ehrenfestPos}}\quad
%\subfloat[Energy]{\label{fig:ehrenfestEnergy}\includegraphics[width=0.525\textwidth]{gfx/Chapter-4/ehrenfestEnergy}}%
%}
