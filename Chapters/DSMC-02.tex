...
One approach might be to apply a finite difference technique directly to the pde, however this technique is not generally conservative \cite{mi_eng}. %unitary evolution conserves probability, inherently stable. % for majorana equation can get explicit expression for u % approximation to integral equation bounded hence stable and easier for higher accuracy.
