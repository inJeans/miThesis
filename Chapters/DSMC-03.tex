...
**REDO sim with exponential decay fixed**
...
\makebox[1.8\linewidth][l]{%
\centering
\subfloat[MCWF Distribution]{\label{fig:mcwfIPDist}\includegraphics[width=0.75\textwidth]{gfx/MCWF/mcwfIPDist}}\quad
\subfloat[MCWF Conservation]{\label{fig:mcwfIPCons}\includegraphics[width=0.75\textwidth]{gfx/MCWF/mcwfIPConserve}}
}
\caption{mcwf method for a gas in an IP trap.}\label{fig:mcwfIP}
\end{figure}
